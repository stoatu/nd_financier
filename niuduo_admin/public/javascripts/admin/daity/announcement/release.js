...
$(document).ready(function() {
    ...
    $(".btn_submits").bind("click",function(){
        $("#add_form").attr("action","/releaseAnnouncement");
        ...
        if((editor.text()).length>3000){
            alert("公告内容不能超过3000汉字。");
            return false;
        }
    ...
    $(".btn_save").bind("click",function(){
        ...
        var form_name = get_form_name( $(this));
        $(this).html("提交并置顶中...");
        ajax_request_post(form_name,{content:editor.html(),top_flag:1},function process_data(data){
            parent.popbox.success();
        },function process_fail(){
            status = 0;
            $(".btn_save").html("提交并置顶");
